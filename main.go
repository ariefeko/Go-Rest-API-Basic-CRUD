...
func main() {
	db, err = gorm.Open("mysql", "root:root@/go_rest_api?charset=utf8&parseTime=True")
...
func handleRequest() {
	log.Println("Start server at http://localhost:9999")
...
func updateProduct(w http.ResponseWriter, r *http.Request) {
	...
	res := Result{Code: 200, Data: product, Message: "Success update products"}
	result, err := json.Marshal(res)
...
func deleteProduct(w http.ResponseWriter, r *http.Request) {
	...
	res := Result{Code: 200, Message: "Success delete products"}
	result, err := json.Marshal(res)
